...
const regenerateTokens = async (
  ...
  //new Tokens will be generated by authmiddleware and send back as response by the refreshToken endpoint
  try {
    console.log("USER_SERVICE ADDRESS:", USERS_SERVICE);
    ...
    console.log("====================================");
    //i will get tokens in response after above request, and users(userData) in the body
